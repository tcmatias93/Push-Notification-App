...
async function registerForPushNotificationsAsync() {
  ...
  //Verifica si estamos en un dispositivo fisico
  if (Device.isDevice) {
    //Comprueba si ya se tiene el permiso de mandar notificaciones push
...
export const usePushNotifications = () => {
  ...
  //Con este useEffect registro el token de acceso
  useEffect(() => {
